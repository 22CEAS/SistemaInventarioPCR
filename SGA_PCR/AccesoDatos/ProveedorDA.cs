...
namespace AccesoDatos
{
    public class ProveedorDA
    {
        ...
        {
            string sql = "Select * From proveedor where ruc='" + proveedor.Ruc 
                + "' or razonSocial='" + proveedor.RazonSocial  + "' ;";
        ...
        public int ModificarProveedor(Proveedor proveedor, string usuario,int actualizarEstado)
        {
            string sql = "";
            if (actualizarEstado == 1)
            {
                sql = "Select * From proveedor where (ruc='" + proveedor.Ruc
                + "' or razonSocial='" + proveedor.RazonSocial + "') and estado=" + proveedor.Estado + " ;";
            }
            else
            {
                sql = "Select * From proveedor where ruc='" + proveedor.Ruc
