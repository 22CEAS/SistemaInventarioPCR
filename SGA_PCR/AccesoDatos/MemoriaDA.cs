...
namespace AccesoDatos
{
    public class MemoriaDA
    {
        ...
        {
            string sql = "Select * From memoria where idModelo=" + memoria.Modelo.IdModelo + " and idBusFrecuencia=" + memoria.IdBusFrecuencia + " and idCapacidad=" + memoria.IdCapacidad + " ;" ;
        ...
        public int ModificarMemoria(Memoria memoria, string usuario, int actualizarEstado)
        {
            ...
            {
                sql = "Select * From memoria where idModelo=" + memoria.Modelo.IdModelo + " and idBusFrecuencia=" + memoria.IdBusFrecuencia + " and idCapacidad=" + memoria.IdCapacidad + " and estado = " + memoria.Estado + " ;";
            }
            else
            {
                sql = "Select * From memoria where idModelo=" + memoria.Modelo.IdModelo + " and idBusFrecuencia=" + memoria.IdBusFrecuencia + " and idCapacidad=" + memoria.IdCapacidad + " ;" ;
            }
            ...
            if (!(reader.HasRows))
            {
                ...
                parametrosEntrada[7] = new MySqlParameter("@_idMemoria", MySqlDbType.Int32);
                ...
                parametrosEntrada[7].Value = memoria.IdMemoria;
