...
namespace Vistas
{
    public partial class frmReporteCuadroVencimiento : Form
    {
        ...
        public frmReporteCuadroVencimiento()
        {
            InitializeComponent();
            Inicializado();
        }

        public frmReporteCuadroVencimiento(int idUsuario, string nombreUsuario)
        {
            InitializeComponent();
