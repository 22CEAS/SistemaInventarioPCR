namespace Vistas
{
    partial class frmProcesoCambioBuscar
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridColumn13.DataPropertyName = "IdCambio";
            gridColumn13.Name = "ID CAMBIO";
            gridColumn14.AllowEdit = false;
            gridColumn14.DataPropertyName = "NombreCliente";
            gridColumn14.Name = "CLIENTE";
            gridColumn14.Width = 210;
            gridColumn15.AllowEdit = false;
            gridColumn15.DataPropertyName = "NombreKam";
            gridColumn15.MinimumWidth = 100;
            gridColumn15.Name = "KAM";
            ...
            gridColumn16.DataPropertyName = "FechaProceso";
            gridColumn16.EditorType = typeof(DevComponents.DotNetBar.SuperGrid.GridDateTimePickerEditControl);
            gridColumn16.MinimumWidth = 100;
            gridColumn16.Name = "FECHA PROCESO";
            gridColumn16.ResizeMode = DevComponents.DotNetBar.SuperGrid.ColumnResizeMode.MaintainTotalWidth;
            gridColumn16.Width = 115;
            gridColumn17.AllowEdit = false;
            gridColumn17.DataPropertyName = "Estado";
            gridColumn17.MinimumWidth = 100;
            gridColumn17.Name = "ESTADO";
            gridColumn18.DataPropertyName = "IdEstado";
            gridColumn18.Name = "idEstado";
            gridColumn18.Visible = false;
            this.dgvCambio.PrimaryGrid.Columns.Add(gridColumn13);
            this.dgvCambio.PrimaryGrid.Columns.Add(gridColumn14);
            this.dgvCambio.PrimaryGrid.Columns.Add(gridColumn15);
            this.dgvCambio.PrimaryGrid.Columns.Add(gridColumn16);
            this.dgvCambio.PrimaryGrid.Columns.Add(gridColumn17);
            this.dgvCambio.PrimaryGrid.Columns.Add(gridColumn18);
