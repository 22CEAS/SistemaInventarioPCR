namespace Vistas
{
    partial class frmProcesoLevantamientoObservacionesBuscar
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridColumn6.DataPropertyName = "IdObservacion";
            gridColumn6.Name = "ID LEVANTAMIENTO";
            gridColumn7.AllowEdit = false;
            gridColumn7.DataPropertyName = "Cliente";
            gridColumn7.Name = "CLIENTE";
            gridColumn7.Width = 210;
            gridColumn8.AllowEdit = false;
            gridColumn8.DataPropertyName = "GuiaLevantamiento";
            gridColumn8.MinimumWidth = 100;
            gridColumn8.Name = "GUIA LEVANTAMIENTO";
            ...
            gridColumn9.DataPropertyName = "FechaProceso";
            gridColumn9.EditorType = typeof(DevComponents.DotNetBar.SuperGrid.GridDateTimePickerEditControl);
            gridColumn9.MinimumWidth = 100;
            gridColumn9.Name = "FECHA PROCESO";
            gridColumn9.ResizeMode = DevComponents.DotNetBar.SuperGrid.ColumnResizeMode.MaintainTotalWidth;
            gridColumn9.Width = 115;
            gridColumn10.DataPropertyName = "CodigoLC";
            gridColumn10.Name = "CODIGO LC";
            this.dgvLevantamiento.PrimaryGrid.Columns.Add(gridColumn6);
            this.dgvLevantamiento.PrimaryGrid.Columns.Add(gridColumn7);
            this.dgvLevantamiento.PrimaryGrid.Columns.Add(gridColumn8);
            this.dgvLevantamiento.PrimaryGrid.Columns.Add(gridColumn9);
            this.dgvLevantamiento.PrimaryGrid.Columns.Add(gridColumn10);
