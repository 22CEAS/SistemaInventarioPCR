...
BEGIN
	SET @codigo=(SELECT CONCAT("PCR-LAP",MAX(idLC)+1) from laptop_cpu);
...
BEGIN
	INSERT INTO cliente (dni,nombre,usuario,password,perfil,estado,email,usuario_ins) values
...
BEGIN
	INSERT INTO cliente (tipoDocumento,nroDocumento,nombre_razonSocial,telefono,email,idKAM,nombreKam,estado,usuario_ins) values
	(_tipoDocumento,_nroDocumento,_nombre_razonSocial,_telefono,_email,_idKAM,_nombreKam,1,_usuario_ins);
END
$$ DELIMITER ;
