...
INSERT INTO `bd_leasein`.`estados` (`idEstado`,`nombreEstado`,`descripcion`) VALUES (0, 'DESACTIVO', NULL),(1, 'ACTIVO', NULL),(2, 'DISPONIBLE', NULL),(3, 'DAÑADO', NULL),(4, 'ALQUILADO', NULL),(5, 'VENDIDO', NULL),(6, 'PRE-ALQUILER', NULL),(7, 'FINALIZADO', NULL),(8, 'NO MODIFICABLE', NULL),(9, 'CAMBIADO', NULL),(10, 'INUTILIZABLE', NULL),(11, 'LEVANTADO', NULL);
UNLOCK TABLES;
COMMIT;
BEGIN;
